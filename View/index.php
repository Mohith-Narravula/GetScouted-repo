...
<main class="form-signin w-100 m-auto">
    ...
    <img class="mb-4" src="../images/logo.png" alt="" width="200" height="115">
...
<div class="container">
  ...
  <div class="row">
    ...
    <input type="submit" class="btn btn-primary"  value="All" name="all">
        <input type="submit" class="btn btn-primary"  value="Player Report" name="player">
            <input type="submit" class="btn btn-primary"  value="Match Report" name="match">
            <input type="submit" class="btn btn-primary"  value="Player Rating Report" name="Rating">
            </form>
          </div>
...
$sqlplayer = "SELECT `id`, `First Name`, `Surname`, `dob`, `nationality`, `height`, `mp`, `sp` FROM `report`";
// $sqlmatch = "SELECT `id`, `ft`, `st`, `md`, `mt`, `venue` FROM `report`";
$resultplayer = mysqli_query($conn, $sqlplayer);
echo "<h3>Player Report</h3>";
echo "<div style='height:300px; overflow: auto; width:500px;'>";
echo "<table class='table table-dark'  style='height:300px;'>";
echo "<tr><th>Id</th><th>First Name</th><th>Surname</th><th>Date Of Birth</th><th>nationality</th><th>height</th><th>Main Position</th><th>Secondary Position</th></tr>";

if (mysqli_num_rows($resultplayer) > 0) {
    // output data of each row
    while($rowplayer = mysqli_fetch_assoc($resultplayer)) {
        echo "<tr>";
        echo "<td>" . $rowplayer["id"]. "</td><td>" . $rowplayer["First Name"]. " </td><td> " . $rowplayer["Surname"]. "</td>";
        echo "<td>" . $rowplayer["dob"]. "</td><td>" . $rowplayer["nationality"]. " </td><td> " . $rowplayer["height"]. "</td>";
        echo "<td>" . $rowplayer["mp"]. "</td><td>" . $rowplayer["sp"]. " </td>";
        echo "</tr>";
...
$sqlplayer = "SELECT `id`, `ft`, `st`, `md`, `mt`, `venue` FROM `report`";
// $sqlmatch = "SELECT `id`, `ft`, `st`, `md`, `mt`, `venue` FROM `report`";
$resultplayer = mysqli_query($conn, $sqlplayer);
echo "<h3>Match Report</h3>";
echo "<div style='height:300px; overflow: auto; width:400px;'>";
echo "<table class='table table-dark'  style='height:300px;'>";
echo "<tr><th>Id</th><th>First Team</th><th>Second Team</th><th>Date</th><th>Time</th><th>Venue</th></tr>";
if (mysqli_num_rows($resultplayer) > 0) {
    // output data of each row
    while($rowplayer = mysqli_fetch_assoc($resultplayer)) {
        echo "<tr><td>" . $rowplayer["id"]. "</td><td>" . $rowplayer["ft"]. " </td><td> " . $rowplayer["st"]. "</td>";
        echo "<td>" . $rowplayer["md"]. "</td><td>" . $rowplayer["mt"]. " </td>";
        echo "<td>" . $rowplayer["venue"]. "</td>";
        echo "</tr>";
    }
} else {
    echo "0 results";
...
$sqlplayer = "SELECT * FROM `Footballer_dataset`";
// $sqlmatch = "SELECT `id`, `ft`, `st`, `md`, `mt`, `venue` FROM `report`";
$resultplayer = mysqli_query($conn, $sqlplayer);
echo "<h3>Player Rating Report</h3>";
echo "<div style='height:300px; overflow: auto; width:600px;'>";
echo "<table class='table table-dark'  style='height:300px;'>";
echo "<tr><th>Name</th><th>Vision</th><th>Awareness</th><th>Movement</th><th>Effort</th><th>Bravery_Physical</th><th>Bravery_Mental</th></tr>";
if (mysqli_num_rows($resultplayer) > 0) {
    // output data of each row
    while($rowplayer = mysqli_fetch_assoc($resultplayer)) {
        echo "<tr><td>" . $rowplayer["Full_Name"]. "</td><td>" . $rowplayer["Vision"]. " </td><td> " . $rowplayer["Awareness"]. "</td>";
        echo "<td>" . $rowplayer["Movement"]. "</td><td>" . $rowplayer["Effort"]. " </td>";
        echo "<td>" . $rowplayer["Bravery_Physical"]. "</td>";
        echo "<td>" . $rowplayer["Bravery_Physical"]. "</td>";
        echo "<td>" . $rowplayer["Bravery_Physical"]. "</td>";
        echo "<td>" . $rowplayer["Bravery_Physical"]. "</td>";
        echo "<td>" . $rowplayer["Bravery_Physical"]. "</td>";
